...
def seed():
    with app.app_context():
        ...
        print("Creating family members across 4 generations...")
        ...
        # Spouse Gen 1
        r_g1_spouse = Relationship(family_id=family.id, person_1_id=g1_grandfather.id, person_2_id=g1_grandmother.id, relationship_type='spouse')
        ...
        r_p1 = Relationship(family_id=family.id, person_1_id=g1_grandfather.id, person_2_id=g2_father.id, relationship_type='parent')
        r_p2 = Relationship(family_id=family.id, person_1_id=g1_grandmother.id, person_2_id=g2_father.id, relationship_type='parent')
        r_p3 = Relationship(family_id=family.id, person_1_id=g1_grandfather.id, person_2_id=g2_uncle.id, relationship_type='parent')
        r_p4 = Relationship(family_id=family.id, person_1_id=g1_grandmother.id, person_2_id=g2_uncle.id, relationship_type='parent')
        r_g2_spouse = Relationship(family_id=family.id, person_1_id=g2_father.id, person_2_id=g2_mother.id, relationship_type='spouse')
        db.session.add_all([r_p1, r_p2, r_p3, r_p4, r_g2_spouse])
        db.session.commit()

        # Generation 3 (User & Siblings & Cousins)
        g3_user = Person(
            family_id=family.id,
            first_name='Eleanor',
            middle_name='Rose',
        ...
        r_p5 = Relationship(family_id=family.id, person_1_id=g2_father.id, person_2_id=g3_user.id, relationship_type='parent')
        r_p6 = Relationship(family_id=family.id, person_1_id=g2_mother.id, person_2_id=g3_user.id, relationship_type='parent')
        r_p7 = Relationship(family_id=family.id, person_1_id=g2_father.id, person_2_id=g3_brother.id, relationship_type='parent')
        r_p8 = Relationship(family_id=family.id, person_1_id=g2_mother.id, person_2_id=g3_brother.id, relationship_type='parent')
        r_g3_spouse = Relationship(family_id=family.id, person_1_id=g3_user.id, person_2_id=g3_spouse.id, relationship_type='spouse')
        db.session.add_all([r_p5, r_p6, r_p7, r_p8, r_g3_spouse])
        db.session.commit()

        # Generation 4 (Children / Grandchildren)
        g4_child = Person(
            family_id=family.id,
            first_name='Clara',
            middle_name='Mae',
        ...
        r_p9 = Relationship(family_id=family.id, person_1_id=g3_user.id, person_2_id=g4_child.id, relationship_type='parent')
        r_p10 = Relationship(family_id=family.id, person_1_id=g3_spouse.id, person_2_id=g4_child.id, relationship_type='parent')
        db.session.add_all([r_p9, r_p10])
        db.session.commit()

        # Seed initial location history breadcrumbs for Eleanor
        ...
        print("Demo Account: demo@example.com / password123")
